var rsr = Raphael('ground', '153.4', '88.15');
var sity = rsr.set();
sity.attr({
  'id': 'sity',
  'name': 'sity'
...
var group_a = rsr.set();
var path_c = rsr.path("M101.18,71.39l22.36-13.11,9.22,5.39L110.4,76.78Zm22.36-12.57L102.09,71.39l8.31,4.86,21.45-12.57Z").attr({
  class: 'cls-2',
  parent: 'sity',
  'stroke-width': '0',
  'stroke-opacity': '1',
...
var path_d = rsr.path("M20.64,24.2l22.25-13L43,11.1l9.22,5.39L30,29.53l-.11.06ZM43,11.63,21.56,24.2l8.31,4.86L51.32,16.49Z").attr({
  class: 'cls-2',
  parent: 'sity',
  'stroke-width': '0',
  'stroke-opacity': '1',
...
var group_b = rsr.set();
var path_e = rsr.path("M 2.93 34.56 60.52 0.85 150.41 53.4 92.81 87.12 2.93 34.56 z").attr({
  class: 'cls-1',
  parent: 'sity',
  'stroke-width': '0',
  'stroke-opacity': '1',
...
var rsrGroups = [sity, group_a, group_b];
sity.push();
group_a.push(path_c, path_d);
group_b.push(path_e, path_f);
